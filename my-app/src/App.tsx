...
export default function App() {
  return (
    <Router>
      <Routes>
        {/* Default: land on OM Load Assignment */}
...
````````{/* -------- Office Manager -------- */}
        ...
        {/* -------- Office Assistant -------- 
        <Route path="/oa/plantilla" element={<OA_Plantilla />} />
        <Route path="/oa/inbox" element={<OA_Inbox />} />

        {/* -------- Dean -------- 
        <Route path="/dean/plantilla" element={<DEAN_Plantilla />} />
        <Route path="/dean/class-retention" element={<DEAN_ClassRetention />} />
        <Route path="/dean/inbox" element={<DEAN_Inbox />} />

        {/* -------- Provost -------- 
        <Route path="/provost/plantilla" element={<PROVOST_Plantilla />} />
        <Route path="/provost/class-retention" element={<PROVOST_ClassRetention />} />
