                ...
                <>
                  ...
                  <div className="grid grid-cols-3 gap-y-5 text-sm mb-8">
                    <div>
                      ...
                      <p className="text-gray-600">CABREDO, RAFAEL ANGISCO</p>
                    </div>
                    <div>
                      <p className="font-semibold text-gray-900">Email</p>
                      <p className="text-gray-600">rafael.cabredo@dlsu.edu.ph</p>
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-4 text-left text-sm mb-4">
                    <div><p className="font-semibold">Teaching</p><p>12.0</p></div>
                    <div><p className="font-semibold">Admin</p><p>6.0</p></div>
                    <div><p className="font-semibold">Research</p><p>0.0</p></div>
                    <div><p className="font-semibold">Faculty Units</p><p>18.0</p></div>
                  </div>
                </>
              )}
